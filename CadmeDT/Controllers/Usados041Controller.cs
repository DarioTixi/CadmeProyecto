...
{
    public class Usados041Controller : Controller
    {
        //Listar los elementos de las tablas
        // GET: Usados041
        ...
        //Esta es la opcion de detalles de un solo campo
        // GET: Usados041/Details/5
        ...
        // GET: Usados041/Create
        //Crear la nueva vista con todos los atributos de la tabla
        public ActionResult Create()
        {
            return View( new usados041());
        }

        // POST: Usados041/Create
        //Metodo para agregar los elementos que deseamos a las tablas
        [HttpPost]
        ...
        //Este es el que en verdad guarda cuando se le edita 
        // POST: Usados041/Edit/5
        [HttpPost]
